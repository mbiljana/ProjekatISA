...
public class Client extends Korisnik{
    ...
    @JoinTable(name = "renting_entity", joinColumns = @JoinColumn(name = "client_id", referencedColumnName = "reg_user_id"), inverseJoinColumns = @JoinColumn(name = "entity_id", referencedColumnName = "entity_id"))
